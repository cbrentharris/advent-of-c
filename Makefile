...
BINARIES = bin/2025_01 bin/2025_02 bin/2025_03 bin/2025_04 bin/2025_05 bin/2025_06 bin/2025_07 bin/2025_08 bin/2025_09 bin/2025_10
TESTS    = bin/test_2025_01_solution bin/test_2025_02_solution bin/test_2025_03_solution bin/test_2025_04_solution bin/test_2025_05_solution bin/test_2025_06_solution bin/test_2025_07_solution bin/test_2025_08_solution bin/test_2025_09_solution bin/test_2025_10_solution
...
bin/2025_10: year2025/day10/main.c year2025/day10/solution.c $(COMMON_OBJ)
	@mkdir -p $(dir $@)
	$(CC) $(CFLAGS) $^ -o $@ $(LDFLAGS)

bin/test_2025_10_solution: year2025/day10/test_solution.c year2025/day10/solution.c $(COMMON_OBJ)
	@mkdir -p $(dir $@)
	$(CC) $(CFLAGS) $^ -o $@ $(LDFLAGS)
